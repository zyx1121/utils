...
export const safariTools: ToolboxTool[] = [
  ...
  scriptTool({ name: "safari_close_tab", description: "Close Safari front tab. Destructive browser state change.", inputSchema: {}, script, envelope, timeoutMs, buildArgs: () => ["close"] }),
